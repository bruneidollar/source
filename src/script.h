...
#ifndef H_BRUNEIDOLLAR_SCRIPT
#define H_BRUNEIDOLLAR_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CbruneidollarAddress
 */
...
public:
    ...
    // Pre-version-0.6, bruneidollar always counted CHECKMULTISIGs
