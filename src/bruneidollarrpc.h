...
#ifndef _BRUNEIDOLLARRPC_H_
#define _BRUNEIDOLLARRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // bruneidollar is not connected
...
/**
 * bruneidollar RPC command dispatcher.
 */
class CRPCTable
{
private:
